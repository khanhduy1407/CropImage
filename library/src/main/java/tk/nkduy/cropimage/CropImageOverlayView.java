...
class CropImageOverlayView extends View implements ConfigChangeListener, OnImagePositionedListener {
    ...
    protected CropImageOverlayConfig config;

    protected boolean shouldDrawOverlay;

    public CropImageOverlayView(Context context, CropImageOverlayConfig config) {
        super(context);
        initWith(config);
    }

    protected void initWith(CropImageOverlayConfig c) {
        config = c;
