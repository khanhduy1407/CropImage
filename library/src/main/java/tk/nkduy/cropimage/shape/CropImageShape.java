...
public abstract class CropImageShape implements ConfigChangeListener {
    ...
    protected CropImageOverlayConfig overlayConfig;

    public CropImageShape(CropImageView cropImageView) {
        this(cropImageView.configureOverlay());
    }

    public CropImageShape(CropImageOverlayConfig config) {
    ...
    public abstract CropImageShapeMask getMask();
